...
export const en = {
  ...
  'agent.examplesTitle': 'Try an example',
  'agent.exampleBook': 'Book a train from Chennai to Hyderabad',
  'agent.exampleCheapest': 'Find the cheapest train from Chennai to Hyderabad',
  'agent.exampleFastest': 'Find the fastest train from Chennai to Hyderabad',
  'agent.exampleConfirmation': 'Give me the best chance of confirmation',
  'agent.exampleTatkal': 'Book Tatkal from Chennai to Hyderabad',
  ...
  'statusTranslator.examplesTitle': 'Try an example',
  'statusTranslator.exampleGnwl': 'Explain GNWL 24',
  'statusTranslator.exampleRac': 'Explain RAC 14',
